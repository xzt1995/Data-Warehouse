...
![数据仓库分层](D:\Workspaces\Data-Warehouse\Data-Warehouse\img\用户行为数仓搭建\数据仓库分层.png)
...
![数据仓库分层](D:\Workspaces\Data-Warehouse\Data-Warehouse\img\用户行为数仓搭建\ods,dwd.png)



![dws.ads](D:\Workspaces\Data-Warehouse\Data-Warehouse\img\用户行为数仓搭建\dws.ads.png)
...
![系统流程设计](D:\Workspaces\Data-Warehouse\Data-Warehouse\img\系统流程设计.png)
...
![tez](D:\Workspaces\Data-Warehouse\Data-Warehouse\img\用户行为数仓搭建\tez.png)
