...
![每日新增设备分析](D:\Workspaces\Data-Warehouse\Data-Warehouse\img\用户行为数仓搭建\每日新增设备分析.png)
...
![用户留存概念](D:\Workspaces\Data-Warehouse\Data-Warehouse\img\用户行为数仓搭建\用户留存概念.png)



### 8.1.2 需求描述

![用户留存率分析](D:\Workspaces\Data-Warehouse\Data-Warehouse\img\用户行为数仓搭建\用户留存率分析.png)
...
![沉默用户](D:\Workspaces\Data-Warehouse\Data-Warehouse\img\用户行为数仓搭建\沉默用户.png)
...
![回流用户](D:\Workspaces\Data-Warehouse\Data-Warehouse\img\用户行为数仓搭建\回流用户.png)
...
![7天内连续三天活跃用户数](D:\Workspaces\Data-Warehouse\Data-Warehouse\img\用户行为数仓搭建\7天内连续三天活跃用户数.png)
